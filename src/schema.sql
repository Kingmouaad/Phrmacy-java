...
-- ============================================
-- 6b. RESTOCKS — Inventory restocking transactions
-- ============================================
...
-- ============================================
-- 6c. RESTOCK_ITEMS — Individual items per restock
-- ============================================
CREATE TABLE restock_items (
    id             INTEGER PRIMARY KEY AUTOINCREMENT,
    transaction_id TEXT NOT NULL REFERENCES restocks(transaction_id) ON DELETE CASCADE,
    product_id     TEXT NOT NULL REFERENCES products(product_id),
    quantity       INTEGER NOT NULL CHECK(quantity > 0)
);

-- ============================================
-- 6d. RETURNS — Refund/return transactions
-- ============================================
CREATE TABLE returns (
    transaction_id   TEXT PRIMARY KEY,
    customer_id      TEXT REFERENCES customers(customer_id),
    pharmacist_id    TEXT NOT NULL,
    original_sale_id TEXT REFERENCES sales(transaction_id) ON DELETE SET NULL,
...
-- ============================================
-- 6e. RETURN_ITEMS — Individual items per return
-- ============================================
CREATE TABLE return_items (
    id             INTEGER PRIMARY KEY AUTOINCREMENT,
    transaction_id TEXT NOT NULL REFERENCES returns(transaction_id) ON DELETE CASCADE,
    product_id     TEXT NOT NULL REFERENCES products(product_id),
    quantity       INTEGER NOT NULL CHECK(quantity > 0)
);
